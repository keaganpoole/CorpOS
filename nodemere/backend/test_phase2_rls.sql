...
create table public."sonar_plans" ("id" uuid, "slug" text, "name" text, "stripe_product_name" text, "sort_order" bigint, "is_public" boolean, "is_recommended" boolean, "display" jsonb, "entitlements" jsonb, "features" jsonb, "created_at" timestamptz, "updated_at" timestamptz);
