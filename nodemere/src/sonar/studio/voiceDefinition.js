export const CHARACTERISTICS = [
  { key: 'gender', label: 'Identity', title: 'Choose a\nname.', hint: "Give your receptionist a name.", options: ['Female', 'Male'], notes: ['A lighter vocal character with a higher typical range.', 'A fuller vocal character with a lower typical range.'] },
...
export const SUB_ACCENTS = {
  ...
  Indian: ['Hindi', 'Bengali', 'Tamil', 'Punjabi', 'Gujarati', 'Malayalam'],
...
export const SUB_ACCENT_PALETTES = {
  ...
  Hindi: ['#0d0709', '#c76230', '#e1b84d'], Bengali: ['#0d0709', '#bd4b66', '#d9a45f'],
  Tamil: ['#0d0709', '#b35535', '#d9a956'], Punjabi: ['#0d0709', '#c56a37', '#dfb64b'],
  Gujarati: ['#0d0709', '#af6541', '#dcb45b'], Malayalam: ['#07100b', '#378c66', '#d4b35c'],
