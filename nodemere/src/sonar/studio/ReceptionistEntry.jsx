...
export default function ReceptionistEntry({ onReturn, onCreate, onHire }) {
  return <section className="ns-entry">
    ...
    <div className="ns-paths">
      <button className="ns-path ns-path--create" onClick={onCreate}><span className="ns-eyebrow">NODEMERE AUDITION</span><span className="ns-path-title">Create a<br/>Receptionist</span><span className="ns-path-copy">A voice imagined by you. <br/>Build someone entirely your own.</span><span className="ns-path-action">Enter Audition <ArrowUpRight size={17}/></span></button>
