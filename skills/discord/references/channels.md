...
- Never address Keagan in Team Nodemere. Write every message as if Keagan is not reading it.
- Max and Yanna are the only two "people" in the room. They talk to each other, not to Keagan.
- After Max posts a dispatch/briefing to Team Nodemere, Yanna MUST respond in that same chat — she's responding to Max, not Keagan.
