...
Aesthetic Failure: The design is a dial-up era eyesore (cluttered, non-modern, or visually repulsive).
...
* **The Digital Deficit:** They must have a "Poor" or "Non-Existent" website. Look for:
    * Non-mobile responsive layouts.
    * Flash-era design elements.
    * Broken links or "Under Construction" banners.
    * Lack of SSL (Not Secure).
* **The Contact Barrier:** A lead is useless without a direct line. A phone number or email is **required**. No "Contact Us" forms only.
...
> **The "Opportunity" Field Logic:** Dan must write a short, blunt assessment of the client's failure. 
> *Example: "Site looks like a 2004 blog. No mobile view. They are losing 50% of their traffic. This is an easy $3k upgrade."*

### Phase 3: The Quality Gate
Lauren performs a "Spot Check" on Dan's entries. If the data is messy or the business is already "Stunning," she rejects the lead and calls it out.

---

## 5. ZONE-SPECIFIC BEHAVIOR
The intensity of research is dictated by the **Global Zone**:

| Active Zone | Research Behavior |
| :--- | :--- |
| **Zone 1-2 (Growth)** | **Maximum Volume.** Dan should find as many leads as possible that meet minimum criteria. Speed > Perfection. |
| **Zone 3-4 (Balanced)** | **High Detail.** Every lead must have a decision-maker's name and a deeper "Opportunity" audit. |
| **Zone 5 (Refinement)** | **Data Hygiene.** No new leads. Dan spends the day cleaning up the existing leads table, finding missing phone numbers, and perfecting the data for Sales. |
