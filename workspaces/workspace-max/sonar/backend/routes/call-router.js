...
router.post('/route', async (req, res) => {
  try {
    ...
    // Step 4: Build the ElevenLabs session config
    const sessionConfig = {
    ...
    // ElevenLabs expects dynamic_variables at the top level
    res.json({
      resolved: true,
      dynamic_variables,
      business: {
      ...
      receptionist: receptionist ? {
        name: receptionist.first_name || receptionist.full_name,
        personality: receptionist.description,
        role: receptionist.stereotype,
