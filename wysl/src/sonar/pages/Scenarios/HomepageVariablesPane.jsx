  ...
  people: [
    {
      ...
      best_time_to_contact: 'Afternoons',
      consent_sms: true,
      consent_call: true,
      source: 'Website',
      last_call_status: 'Answered',
      last_intent: 'Booking',
      last_outcome: 'Requested callback',
    },
  ],
  payments: [
    {
      ...
      payment_method: 'card',
      description: 'Demo deposit for service booking',
  ...
  appointments: [
    {
      ...
      duration: 45,
      status: 'demo_pending',
      notes: 'Demo appointment data only',
    },
  ],
  services: [
    {
      ...
      description: 'Demo service used for homepage workflow testing',
