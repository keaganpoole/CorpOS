  ...
  people: [
    {
      ...
      street_address: '4812 Winding Oak Dr',
      city: 'Austin',
      state: 'TX',
      zip_code: '78704',
      preferred_contact_method: 'Text',
      preferred_language: 'English',
      best_time_to_contact: 'After 3 PM',
      consent_sms: true,
      consent_call: true,
      do_not_call: false,
      do_not_text: false,
      source: 'Instagram',
      lead_source_detail: 'Promoted haircut and styling post',
      special_instructions: 'Allergic to fragrance-heavy products',
      last_call_status: 'Answered',
      last_intent: 'Color consultation',
      last_outcome: 'Booked color service',
      missed_call_count: 1,
      stripe_customer_id: 'cus_demo_8F3K',
      stripe_payment_method_id: 'pm_demo_2Q9L',
  ...
  payments: [
    {
      ...
      description: 'Deposit for balayage and haircut',
      receipt_url: 'https://example.com/demo-receipt',
      stripe_payment_intent_id: 'pi_demo_test_data',
      stripe_session_id: 'cs_demo_4J1M',
      refunded_amount: 0,
      error_message: '',
      created_at: '2026-06-19T11:12:00Z',
      updated_at: '2026-06-19T11:12:00Z',
    },
  ],
  invoices: [
    {
      id: 'demo-invoice-001',
      invoice_id: 'in_demo_test_data',
      amount_due: 12500,
      amount_paid: 12500,
      currency: 'usd',
      status: 'paid',
      customer_id: 'cus_demo_test_data',
      hosted_invoice_url: 'https://example.com/demo-invoice',
      invoice_pdf: 'https://example.com/demo-invoice.pdf',
      due_date: '2026-06-24T00:00:00Z',
      metadata: 'Salon color service package',
    },
  ],
  appointments: [
    {
      ...
      duration: 45,
      status: 'confirmed',
      notes: 'Balayage consultation with Taylor Bennett',
  ...
  services: [
    {
      id: 'demo-service-001',
      name: 'Highlights',
      description: 'Partial highlight service with toner and blowout',
      category: 'Color',
      price_type: 'fixed',
      price_min: 140,
      price_max: 140,
  ...
  hired_receptionists: [
    {
      ...
      full_name: 'Maggie',
      first_name: 'Maggie',
      description: 'Warm, polished salon receptionist for homepage testing',
      phone_number: '(555) 018-2020',
      voice: 'Warm professional female',
      elevenlabs_voice_id: 'demo-voice-maggie',
      age: 32,
      call_types: 'Inbound booking, outbound confirmations, follow-up',
      status: 'active',
      stereotype: 'Professional',
      avatar: 'https://grpgmhhtmfiwukncucaq.supabase.co/storage/v1/object/public/avatars/maggie.png',
      banner_url: getReceptionistBannerUrl('maggie'),
      is_active: true,
      language_model: 'gpt-4.1-mini',
      current_activity: 'Greeting salon callers',
      total_calls: 184,
      inbound_calls_count: 121,
      outbound_calls_count: 63,
      completed_calls_count: 168,
      failed_calls_count: 8,
      missed_calls_count: 3,
      average_call_duration_seconds: 186,
      last_call_at: '2026-06-19T10:40:00Z',
      hired_at: '2026-05-12T09:00:00Z',
    },
  ],
  businesses: [
    {
      ...
      name: 'Oak & Ivy Salon',
      phone: '(555) 010-1000',
      email: 'hello@oakandivysalon.example',
      address: '1201 Congress Ave',
      city: 'Austin',
      state: 'TX',
      zip: '78701',
      website: 'https://oakandivysalon.example',
      about_us: 'Upscale salon demo business for visualizing homepage variables.',
      policies: '24-hour cancellation policy applies to all color services.',
      faq: 'Call or text for cuts, color, and booking questions.',
      business_hours: 'Tue-Sat 9:00 AM - 7:00 PM',
...
const VariablesPane = ({ visible, fieldLabel, onInsertVariable, onTableHover, onClose, style = {}, nodes = [], edges = [], currentNodeId = '', demoMode = false, demoPeopleCustomFields = [] }) => {
  ...
  useEffect(() => {
    ...
    const fetchAll = async () => {
      ...
      for (const table of available) {
        const data = demoMode ? (DEMO_RECORDS[table.key] || []) : await table.fetch();
    ...
    fetchAll();
  }, [visible, currentNodeId, nodes, edges, customFieldsReady, currentNode, demoMode]);
  ...
  useEffect(() => {
    ...
    return () => { cancelled = true; };
  }, [visible, currentNodeId, nodes, edges, demoMode]);
